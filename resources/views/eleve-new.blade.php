...
<body>
  <div class="sidebar">
    ...
    <a href="#"><i class="fas fa-play-circle"></i> Regarder Vidéos</a>
    ...
    <div class="card-grid">
      ...
      <div class="card card-circulation" onclick="window.location.href='/circulation-sanguin'">
        <div class="card-content">
          ...
          <button class="btn-launch">Exécuter <i class="fas fa-arrow-right"></i></button>
        </div>
      </div>
      ...
      <!-- Carte 7 : La tectonique des plaques -->
      ...
      <div class="card card-mitose" onclick="window.location.href='/photosynthese'">
        <div class="card-content">
          ...
          <p>Simulation du processus de photosynthèse</p>
          <button class="btn-launch">Exécuter <i class="fas fa-arrow-right"></i></button>
        </div>
      </div>
    </div>
